...
#include "ApplyRegistrationMatrixCLP.h"
...
/*Get Environment Variable*/
  ...
  std::string pPath;
  pPath = itksys::SystemTools::FindProgram("ResampleScalarVectorDWIVolume");
...
/*Endvironment Variable*/
  ...
  try{
	...
	args.push_back("--inputVolume");
	args.push_back(inputVolume.c_str());
	args.push_back("--outputVolume");
